...
/**
 * Generates certificate pairs for the File Server. 
 * The private certificate is used by the File Server, and the Client and File Server use the public certificate.
 * The File Server(s) will send the public certificate to clients when they connect.
